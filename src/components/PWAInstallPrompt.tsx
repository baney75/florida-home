...
export function PWAInstallPrompt() {
    ...
    if (isUpdateAvailable) {
      return (
        <div className={toastContainerClass} role="status" aria-live="polite">
          <div className="pointer-events-auto rounded-lg border border-[#800000]/25 bg-[#800000] px-3 py-2 text-white shadow-lg">
  ...
  if (canInstall) {
    return (
      <div className={toastContainerClass} role="status" aria-live="polite">
        <div className="pointer-events-auto rounded-lg border border-[#800000]/20 bg-white px-3 py-2 shadow-lg">
          <div className="flex items-center gap-2">
